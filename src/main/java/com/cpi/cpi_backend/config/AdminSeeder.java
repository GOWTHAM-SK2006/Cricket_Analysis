    ...
    private void seedDefaultConfig() {
        String defaultParameters = """
            ...
            String defaultRecommendations = """
                [
                  {"parameter": "Technique", "high": "Maintain mechanical precision through periodic high-speed video feedback.", "avg": "Incorporate stationary shadow batting and tee-work to refine bat path.", "low": "Revisit fundamental grip, stance, and balance setup with dedicated 1-on-1 coaching."},
            ...
            String defaultAiCoach = """
                {
                  ...
                  "parameterAnalysisInstructions": "Evaluate all 7 parameters (Technique, Skill Level, Game Plan, Preparation, Intensity, Focus, Resilience) on a 10-point scale.",
