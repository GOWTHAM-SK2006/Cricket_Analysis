    ...
    private void seedDefaultConfig() {
        String defaultParameters = """
            ...
            String defaultRecommendations = """
                [
                  {"parameter": "Technical Execution", "high": "Protect what already works. Do not make technical changes simply to demonstrate that you are coaching.", "avg": "High score: protect, challenge and refine.", "low": "Identify the root cause. Establish whether the problem is technical, physical, mental, tactical or a combination of these."},
            ...
            String defaultReports = """
                {
                  ...
                  "helpItems": [
                    {"parameter": "Technical Execution", "explanation": "Technical execution measures how effectively a player applies their skills during competitive play and practice.", "rangeHigh": "Scores 7.0-10.0: High score: protect, challenge and refine.", "rangeAvg": "Scores 5.0-6.9: A high score tells you that the player's technique is currently a strength.", "rangeLow": "Scores 0.0-4.9: Low score: diagnose, simplify and rebuild."},
