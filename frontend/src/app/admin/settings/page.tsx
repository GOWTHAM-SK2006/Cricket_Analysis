...
import { Settings, Save, Lock, ShieldCheck, Download, Loader2, KeyRound, Scale, Edit3, Eye, EyeOff } from "lucide-react";
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                placeholder="••••••••••••"
                className="w-full bg-slate-50 border border-slate-300 rounded-xl px-4 py-2.5 pr-10 text-xs text-slate-900 font-bold focus:outline-none focus:border-orange-500"
              />
              <button
                type="button"
