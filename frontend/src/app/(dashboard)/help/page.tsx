  ...
  return (
    <div className="space-y-6 pb-12 select-none max-w-2xl mx-auto text-left">
      ...
      <div className="bg-white border-2 border-slate-200 rounded-3xl p-5 space-y-4">
        ...
        <p className="text-xs font-semibold text-slate-900 leading-relaxed">
          When assessing a player across the Practice Performance Index (PPI) and Match Performance Index (MPI), the coach should keep a broad view of the player’s total game.
        </p>
        <p className="text-xs font-medium text-slate-900 leading-relaxed">
          Where possible, score the player during or immediately after practice and matches on a scale of 0 to 10. Add short, thoughtful notes that explain the score and provide context.
        </p>
      </div>
