  ...
  return (
    <div className="space-y-6 pb-12 select-none">
      ...
      <div className="bg-zinc-950 border-2 border-zinc-900 rounded-3xl p-5 space-y-4">
        ...
        <ul className="text-xs font-bold text-white space-y-1 pl-4 list-disc">
        ...
        <div className="pt-2 border-t border-zinc-900 space-y-2">
          <ul className="text-xs font-medium text-zinc-100 space-y-2 pl-2">
            <li><span className="text-white font-extrabold underline decoration-orange-500/40">Technique:</span> <span className="text-white font-medium">The quality and repeatability of the basic technique and skills a player uses to perform their role effectively.</span></li>
            <li><span className="text-white font-extrabold underline decoration-orange-500/40">Intensity:</span> <span className="text-white font-medium">The energy, purpose and competitive effort a player brings to every part of his and the team practice.</span></li>
            <li><span className="text-white font-extrabold underline decoration-orange-500/40">Execution:</span> <span className="text-white font-medium">The player’s ability to turn the practiced skill or technique required, into an effective and repeatable action under pressure or instruction.</span></li>
            <li><span className="text-white font-extrabold underline decoration-orange-500/40">Adaptability:</span> <span className="text-white font-medium">The player’s ability to adjust their approach, technique and decision-making when conditions, challenges or situations change during practice or are not to their liking.</span></li>
            <li><span className="text-white font-extrabold underline decoration-orange-500/40">Discipline:</span> <span className="text-white font-medium">The player’s ability to follow instructions, maintain standards, stay committed to the task and make responsible choices throughout practice.</span></li>
            <li><span className="text-white font-extrabold underline decoration-orange-500/40">Concentration:</span> <span className="text-white font-medium">The player’s ability to stay mentally focused, remain engaged in the practice and give full attention to each skill, repetition and instruction.</span></li>
            <li><span className="text-white font-extrabold underline decoration-orange-500/40">Coachability:</span> <span className="text-white font-medium">The player’s willingness and ability to listen, understand feedback, apply coaching advice and instruction and ask questions to improve their performance.</span></li>
            <li><span className="text-white font-extrabold underline decoration-orange-500/40">Preparation:</span> <span className="text-white font-medium">How well a player arrives physically, mentally and practically ready to perform their role and make the most of the practice session.</span></li>
          </ul>
        </div>
      </div>
      ...
      <div className="bg-zinc-950 border-2 border-zinc-900 rounded-3xl p-5 space-y-4">
        ...
        <div className="pt-2 border-t border-zinc-900 space-y-2">
          <ul className="text-xs font-medium text-zinc-100 space-y-2 pl-2">
            <li><span className="text-white font-extrabold underline decoration-orange-500/40">Technical Execution:</span> <span className="text-white font-medium">How confidently and effectively the player applied their core skills and technique in the match, under the pressure, conditions and demands of competition.</span></li>
            <li><span className="text-white font-extrabold underline decoration-orange-500/40">Decision Making:</span> <span className="text-white font-medium">This measures how well the player read the situation, understood what was required, and chose the right option at the right time.</span></li>
            <li><span className="text-white font-extrabold underline decoration-orange-500/40">Game Awareness:</span> <span className="text-white font-medium">How well the player understood what was happening in the match and adjusted their role, game plan and decisions accordingly.</span></li>
            <li><span className="text-white font-extrabold underline decoration-orange-500/40">Resilience:</span> <span className="text-white font-medium">How well the player responds to mistakes, setbacks and pressure during the match, and how quickly they can reset, stay involved and perform effectively again.</span></li>
            <li><span className="text-white font-extrabold underline decoration-orange-500/40">Emotional Control:</span> <span className="text-white font-medium">How well the player managed pressure, intimidation, frustration, excitement and disappointment during the match while staying composed, focused and able to perform their role effectively.</span></li>
            <li><span className="text-white font-extrabold underline decoration-orange-500/40">Teamwork:</span> <span className="text-white font-medium">How effectively the player supported teammates, fulfilled their role and contributed to the team’s overall performance throughout the match.</span></li>
            <li><span className="text-white font-extrabold underline decoration-orange-500/40">Match Impact:</span> <span className="text-white font-medium">Measures how effectively the player’s overall performance, presence and actions influenced the course of the match and helped the team’s chances of success.</span></li>
            <li><span className="text-white font-extrabold underline decoration-orange-500/40">Preparation:</span> <span className="text-white font-medium">How well the player arrived physically, mentally and practically ready to perform their role to meet the demands of the match.</span></li>
          </ul>
        </div>
      </div>
        ...
        <div className="space-y-4 pt-1">
          <div className="space-y-1 pb-3 border-b border-zinc-900">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-black text-white uppercase">- NEEDS ATTENTION</span>
            </div>
            <p className="text-xs font-medium text-white leading-relaxed">
          ...
          <div className="space-y-1 pb-3 border-b border-zinc-900">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-black text-white uppercase">- DEVELOPING</span>
            </div>
            <p className="text-xs font-medium text-white leading-relaxed">
          ...
          <div className="space-y-1">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-black text-white uppercase">- STRONG</span>
            </div>
            <p className="text-xs font-medium text-white leading-relaxed">
      ...
      <div className="bg-zinc-950 border-2 border-zinc-900 rounded-3xl p-5 space-y-4">
        ...
        <ul className="text-xs font-bold text-white space-y-2 pl-4 list-disc">
