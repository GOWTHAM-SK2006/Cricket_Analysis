...
export default function OrganizationPage() {
  ...
  return (
    <div className="space-y-8 pb-6 px-4">
      ...
      {successMsg && (
        <div className="bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 p-4.5 rounded-xl flex items-center gap-2 text-sm font-semibold">
      ...
      {error && (
        <div className="bg-red-500/10 border border-red-500/20 text-red-400 p-4.5 rounded-xl flex items-center gap-2 text-sm font-semibold">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        {org && (
          <div className="bg-white/5 border border-white/10 rounded-xl p-5 sm:p-6 hover:bg-white/10 transition-all duration-200 shadow-lg relative group overflow-hidden backdrop-blur-md">
            <div className="absolute top-0 right-0 w-24 h-24 bg-orange-500/5 rounded-full blur-2xl pointer-events-none" />
            
            <div className="flex items-center gap-3.5 mb-4.5">
              <div className="w-11 h-11 rounded-xl bg-orange-500/10 flex items-center justify-center text-orange-500">
                <Building className="w-5 h-5" />
              </div>
              <div>
                <h3 className="text-base lg:text-lg font-bold text-white">{org.name}</h3>
                <span className="text-[10px] px-2 py-0.5 rounded bg-white/5 border border-white/10 text-orange-500 font-bold uppercase">{org.type}</span>
              </div>
            </div>

            <div className="space-y-3.5 text-sm pt-3.5 border-t border-white/10">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <span className="text-zinc-500 text-[10px] uppercase font-bold tracking-wider">Sport</span>
                  <p className="text-zinc-200 mt-0.5 text-xs font-bold">{org.sport}</p>
                </div>
                <div>
                  <span className="text-zinc-500 text-[10px] uppercase font-bold tracking-wider">Location</span>
                  <p className="text-zinc-200 mt-0.5 text-xs font-bold">{org.city}, {org.country}</p>
                </div>
              </div>
              {org.description && (
                <div>
        ...
        <div className="grid grid-cols-2 gap-4 lg:col-span-1">
          <div className="bg-white/5 border border-white/10 rounded-xl p-5 flex flex-col justify-between backdrop-blur-md hover:bg-white/10 transition-all duration-200">
            <div className="text-zinc-400 text-[10px] uppercase font-bold tracking-wider">Coaches</div>
            <div className="mt-2.5 flex items-baseline justify-between">
              <span className="text-2xl lg:text-3xl font-extrabold text-white">{stats.totalCoaches}</span>
              <Users className="w-5 h-5 text-orange-500" />
            </div>
          </div>

          <div className="bg-white/5 border border-white/10 rounded-xl p-5 flex flex-col justify-between backdrop-blur-md hover:bg-white/10 transition-all duration-200">
            <div className="text-zinc-400 text-[10px] uppercase font-bold tracking-wider">Teams</div>
            <div className="mt-2.5 flex items-baseline justify-between">
              <span className="text-2xl lg:text-3xl font-extrabold text-white">{stats.totalTeams}</span>
              <Trophy className="w-5 h-5 text-orange-500" />
            </div>
          </div>

          <div className="bg-white/5 border border-white/10 rounded-xl p-5 flex flex-col justify-between backdrop-blur-md hover:bg-white/10 transition-all duration-200">
            <div className="text-zinc-400 text-[10px] uppercase font-bold tracking-wider">Players</div>
            <div className="mt-2.5 flex items-baseline justify-between">
              <span className="text-2xl lg:text-3xl font-extrabold text-white">{stats.totalPlayers}</span>
              <Users className="w-5 h-5 text-orange-500" />
            </div>
          </div>

          <div className="bg-white/5 border border-white/10 rounded-xl p-5 flex flex-col justify-between backdrop-blur-md hover:bg-white/10 transition-all duration-200">
            <div className="text-zinc-400 text-[10px] uppercase font-bold tracking-wider">Pending</div>
            <div className="mt-2.5 flex items-baseline justify-between">
              <span className="text-2xl lg:text-3xl font-extrabold text-amber-500">{pendingCoaches.length}</span>
        ...
        {org && (
          <div className="bg-white/5 border border-white/10 rounded-xl p-5 sm:p-6 backdrop-blur-md flex flex-col justify-between hover:bg-white/10 transition-all duration-200">
            <div>
              <p className="text-zinc-400 text-[10px] uppercase font-bold tracking-wider mb-2.5">Join Code</p>
              <div className="flex gap-2.5">
                ...
                <button
                  ...
                  className="w-11 h-11 rounded-xl bg-white/5 border border-white/10 text-zinc-300 hover:text-white hover:bg-white/10 transition-all flex items-center justify-center cursor-pointer"
      ...
      {pendingCoaches.length > 0 && (
        <div className="bg-white/5 border border-white/10 rounded-xl p-5 sm:p-6 backdrop-blur-md space-y-4">
          <h3 className="text-lg lg:text-[24px] font-extrabold text-white flex items-center gap-2">
            <Clock className="w-5 h-5 text-amber-500" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {pendingCoaches.map((coach) => (
              <div
                key={coach.id}
                className="bg-black/40 border border-white/5 rounded-xl p-3.5 flex justify-between items-center gap-4 hover:border-orange-500/20 transition-colors"
              >
                <div>
                  <h4 className="font-bold text-white text-sm">{coach.name}</h4>
                  <p className="text-[11px] text-zinc-550 mt-0.5">{coach.email}</p>
                </div>
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    disabled={actioningId === coach.id}
                    className="h-9 px-4 rounded-lg bg-white/5 hover:bg-white/10 border border-white/10 text-red-400 font-bold text-xs transition-all cursor-pointer"
                  >
                    Reject
                  </button>
                </div>
      ...
      <div className="space-y-4">
        ...
        {filteredApprovedCoaches.length === 0 ? (
          <div className="py-14 text-center text-zinc-500 border border-dashed border-white/5 rounded-xl flex flex-col items-center justify-center gap-2">
            <Users className="w-12 h-12 text-zinc-700" />
            <p className="font-bold text-zinc-400 text-sm">No coaches match search query</p>
            <p className="text-xs text-zinc-650">Ensure coaches are registered and approved in your organization</p>
          </div>
        ) : (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {filteredApprovedCoaches.map((coach) => (
              <motion.div
                ...
                className={`bg-white/5 hover:bg-white/10 border border-white/10 rounded-xl p-5 backdrop-blur-md cursor-pointer transition-all relative ${
              ...
              >
                <div className="flex justify-between items-start gap-4">
                  <div className="flex items-center gap-3.5">
                    ...
                    <div>
                      ...
                      <span className="text-[9px] tracking-wider uppercase font-bold px-1.5 py-0.5 rounded bg-orange-500/10 border border-orange-500/20 text-orange-500 mt-0.5 inline-block">
                        {coach.role}
                      </span>
                    </div>
                  </div>
                ...
                <p className="text-xs text-zinc-400 mt-3.5 break-all">{coach.email}</p>
                ...
                <div className="grid grid-cols-3 gap-2.5 mt-4 pt-3.5 border-t border-white/5 text-center text-xs">
                  <div>
                    ...
                    <span className="font-bold text-zinc-200 mt-0.5 block">{coach.teamsCount}</span>
                  </div>
                  <div>
                    <span className="text-zinc-500 block text-[9px] uppercase font-bold">Players</span>
                    <span className="font-bold text-zinc-200 mt-0.5 block">{coach.playersCount}</span>
                  </div>
                  <div>
        ...
        {selectedCoachId !== null && (
          <div className="fixed inset-0 z-50 flex justify-end">
            ...
            <motion.div
              ...
              className="relative w-full max-w-md bg-[#0a0a0a] border-l border-white/10 h-full flex flex-col overflow-y-auto p-6 text-white z-10"
            >
              {/* Close button */}
              <button
                onClick={() => {
                  ...
                  <div className="space-y-5">
                    ...
                    <div className="flex items-center gap-3.5">
                      ...
                      <div>
                        ...
                        <span className="text-[9px] tracking-wider uppercase font-bold px-1.5 py-0.5 rounded bg-orange-500/10 border border-orange-500/20 text-orange-500 mt-1 inline-block">
                          {coachDetails.role}
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="space-y-3.5">
                      <div className="flex justify-between items-center">
                        ...
                        {!showCreateTeam && (
                          <button
                            ...
                            className="h-9 px-4 rounded-lg bg-orange-600 hover:bg-orange-500 text-white text-xs font-bold shadow-md transition-colors cursor-pointer flex items-center gap-1"
                          >
                      ...
                      {showCreateTeam && (
                        <motion.form
                          ...
                          className="bg-white/5 border border-orange-500/20 rounded-xl p-4 space-y-3.5"
                        >
                          <div className="flex justify-between items-center">
                          ...
                          <div className="space-y-3">
                            <div>
                              <label className="text-[9px] text-zinc-450 uppercase font-bold block mb-1">Team Name</label>
                              <input
                                type="text"
                                ...
                                required
                                className="h-10 w-full bg-black/60 border border-white/10 rounded-lg px-3.5 text-xs text-white placeholder:text-zinc-600 focus:outline-none focus:border-orange-500"
                              />
                            </div>
                            <div>
                              <label className="text-[9px] text-zinc-450 uppercase font-bold block mb-1">Skill Category</label>
                              <select
                                value={newTeamLevel}
                                onChange={(e) => setNewTeamLevel(e.target.value)}
                                className="h-10 w-full bg-black/60 border border-white/10 rounded-lg px-3 text-xs text-white focus:outline-none focus:border-orange-500"
                              >
                          ...
                          <div className="flex justify-end gap-2 pt-1.5">
                            <button
                              type="button"
                              onClick={() => setShowCreateTeam(false)}
                              className="h-9 px-3 bg-white/5 border border-white/10 text-zinc-300 text-xs rounded-lg font-bold hover:bg-white/10 transition-colors"
                            >
                              Cancel
                            </button>
                            <button
                              ...
                              className="h-9 px-3 bg-orange-600 hover:bg-orange-500 disabled:opacity-50 text-white text-xs rounded-lg font-bold transition-colors flex items-center gap-1"
                            >
                      ...
                      {coachDetails.teams.length === 0 ? (
                        <div className="py-8 text-center text-zinc-500 border border-dashed border-white/5 rounded-xl text-xs flex flex-col items-center gap-1.5">
                        ...
                        <div className="space-y-2">
                          {coachDetails.teams.map((team) => (
                            <div
                              key={team.id}
                              className="bg-black/40 border border-white/5 rounded-xl p-3.5 flex justify-between items-center hover:border-orange-500/20 transition-all"
                            >
                              <div>
                  ...
                  {coachDetails.role !== "ADMIN" && (
                    <div className="border-t border-white/10 pt-4 mt-6 flex justify-between items-center">
                      ...
                      <button
                        ...
                        className="h-10 px-4 bg-red-950/40 hover:bg-red-950/80 border border-red-500/20 text-red-400 font-bold text-xs rounded-lg flex items-center gap-1.5 shadow-md transition-colors cursor-pointer"
                      >
