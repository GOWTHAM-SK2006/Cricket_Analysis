    ...
    <div className="max-w-4xl mx-auto space-y-8">
      <div className="flex items-center justify-between">
        ...
        <div className="text-right">
          <p className="text-sm text-zinc-400 font-medium uppercase tracking-wider mb-1">Total MPI</p>
          <div className="text-4xl font-bold text-emerald-400">{mpiScore}</div>
        </div>
      </div>
      ...
      <div className="bg-white/5 border border-white/10 p-8 rounded-3xl space-y-8">
        ...
        <button className="w-full bg-emerald-600 hover:bg-emerald-500 text-white rounded-xl py-4 font-medium transition-all text-lg shadow-[0_0_20px_rgba(16,185,129,0.3)] hover:shadow-[0_0_30px_rgba(16,185,129,0.5)]">
          Save Assessment
        </button>
      </div>
    </div>
