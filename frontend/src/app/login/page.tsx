    ...
    <div className="min-h-screen bg-white dark:bg-black text-zinc-900 dark:text-white flex flex-col justify-between p-6 select-none transition-colors">
      <div className="my-auto max-w-md w-full mx-auto space-y-8">
        ...
        <div className="text-center">
          ...
          <h1 className="text-4xl font-black tracking-tight text-zinc-900 dark:text-white mb-2 uppercase">WELCOME</h1>
          <p className="text-zinc-500 dark:text-zinc-400 text-lg font-bold">Cricket Performance Index</p>
        </div>

        {/* Main form */}
        <form onSubmit={handleLogin} className="space-y-6">
          {error && (
            <div className="bg-red-500/10 border-2 border-red-500 text-red-600 dark:text-red-300 p-4 rounded-2xl text-sm font-bold text-center">
              {error}
            </div>
          )}
