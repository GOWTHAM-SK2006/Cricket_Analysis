...
export default function Home() {
  return (
    <div className="min-h-screen bg-[#FAF9F6] text-slate-900 selection:bg-orange-500/20 font-sans flex flex-col">
      ...
      {/* Hero Section */}
      <main className="pt-32 sm:pt-44 pb-12 px-6 relative overflow-hidden flex-1 flex flex-col items-center justify-start">
        <div className="max-w-5xl mx-auto relative z-10 text-center pt-8 sm:pt-16">
          <motion.div
